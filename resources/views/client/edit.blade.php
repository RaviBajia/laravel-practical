            ...
            <div class="container mx-auto px-6 py-1 pb-16">
              <div class="bg-white shadow-md rounded my-6 p-5">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <textarea name="address" id="address" placeholder="Enter address" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" rows="5">{{ old('address',$client->address) }}</textarea>
                </div>
                ...
                <div class="flex flex-col space-y-2">
                  ...
                  <input id="city" type="text" name="city" value="{{ old('city',$client->city) }}"
                    placeholder="Enter city" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                  />
                </div>

                <div class="flex flex-col space-y-2">
                    <label for="notes" class="text-gray-700 select-none font-medium">Notes</label>
                    <textarea name="notes" id="notes" placeholder="Enter address" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" rows="5">{{ old('notes',$client->notes) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-3 gap-4">
                  <div class="relative inline-flex">
                    ...
                    <select class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none" name="active">
                      <option value="0">Inactive</option>
                      <option value="1" @if($client->active) selected @endif>Active</option>
                    </select>
                  </div>
                </div>
