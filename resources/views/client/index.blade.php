  ...
  <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
      <div class="container mx-auto px-6 py-2">
          <div class="text-right">
            @can('Client create')
              <a href="{{route('admin.clients.create')}}" class="bg-blue-500 text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">New client</a>
            @endcan
          </div>
          ...
          <table class="text-left w-full border-collapse">
            <thead>
              <tr>
                ...
                <th class="py-4 px-6 bg-grey-lightest font-bold text-sm text-grey-dark border-b border-grey-light">Notes</th>
            ...
            <tbody>
              @can('Client access')
                ...
                <tr class="hover:bg-grey-lighter">
                  ...
                  <td class="py-4 px-6 border-b border-grey-light">{{ $client->address }}</td>
                  <td class="py-4 px-6 border-b border-grey-light">{{ $client->city }}</td>
                  <td class="py-4 px-6 border-b border-grey-light">{{ $client->notes }}</td>
                  ...
                  <td class="py-4 px-6 border-b border-grey-light text-right">
                    ...
                    @can('Client edit')
                    <a href="{{route('admin.clients.edit',$client->id)}}" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-blue-400">Edit</a>
                    @endcan
